...
(b)   Students.</label>
    <div class="form-group">
        <textarea class="form-control" id="housing" required="required" rows="3" cols="58" name="housing"></textarea>
  </div>
  </div>
...
<a class="btn btn-primary login-btn" href="vcssf6.php" style=" width: 95%; ">Pevious</a>
  ...
  <div class="col">
<a class="btn btn-primary login-btn" href="vcssf8.php" style="float: right;margin-right: 4%; width: 95%; ">Next</a>
 </div>
