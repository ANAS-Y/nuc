...
if( $num_row> 0){
    ...
    echo '<select required class=" form-control" arial-label=".form-select example" name="id">
...
?>
<script>window.location="panel.members.php"</script>
<?php }?>
      </div>
      </div>
    </main>
